...
for intent in ['AddToPlaylist', 'BookRestaurant', 'GetWeather', 'PlayMusic', 'RateBook', 'SearchCreativeWork',
    ...
    with open("./nlu-benchmark-master/2017-06-custom-intent-engines/" + intent + "/train_" + intent + ".json",
    ...
    with open("./nlu-benchmark-master/2017-06-custom-intent-engines/" + intent + "/train_" + intent + "_full.json",
              encoding='cp1251') as data_file:
