...
data = pd.read_csv("./intent_data/snips_intent_ner.csv")
print(data.head())
...
for train_index, test_index in kf_split.split(data['request'], stratif_y):
    ...
    ner_train, ner_test = data.loc[train_index, 'ner_tag'].values, data.loc[test_index, 'ner_tag'].values
    ...
    train_tags_table = keras.preprocessing.sequence.pad_sequences(train_tags_table, maxlen=text_size, padding='pre')

    print(X_train_embed.shape)
    print(train_tags_table.shape)
    ...
    test_tags_table = keras.preprocessing.sequence.pad_sequences(test_tags_table, maxlen=text_size, padding='pre')

    print(X_test_embed.shape)
    print(test_tags_table.shape)
